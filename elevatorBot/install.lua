...
local urls = {
    ...
    kaifox = "https://raw.githubusercontent.com/KaiDevvy/personal-cctweaked/refs/heads/main/elevatorBot/"
}

local files = {
    {url = urls["kaifox"], file = "startup.lua" },
    {url = urls["kaifox"], file = "music.lua" },
    {url = urls["kaifox"], file = "data/songs/elevator.dfpwm", dest = "data/songs/"}
}
